...
$this->title                   = $model->isNewRecord ? __('Create Project') : $model->name;
$this->params['breadcrumbs'][] = ['url' => ['course/index'], 'label' => __('Manage Projects')];
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <?= $form->field($model, 'status')->widget(ChosenSelect::className(), [
                    'items'         => Project::getStatusOptions(),
