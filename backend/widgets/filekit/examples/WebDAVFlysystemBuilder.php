 ...
 * @link https://github.com/backend\widgets/yii2-file-kit/issues/46
 */
class WebDAVFlysystemBuilder implements FilesystemBuilderInterface
{
    ...
    public function build()
    {
        ...
        \yii\base\Event::on(\backend\widgets\filekit\Storage::className(), \backend\widgets\filekit\Storage::EVENT_BEFORE_SAVE, function ($event) {
            /** @var \backend\widgets\filekit\Storage $storage */
